...
public class SeriesService {
    ...
    public Series getSeriesById(Long id) {
        return seriesRepository
            .findById(id)
            .orElseThrow(() -> new SeriesNotFound("seriesId=" + id));
    }
    ...
    public String uploadImage(MultipartFile image, Long userId, String imagePurpose)
        throws IOException {
        return s3Uploader.upload(image, Series.class.getSimpleName(), userId, imagePurpose);
    }
